package binary404.mystica.client.render.tile;
...
public class RenderMobCrystal extends TileEntityRenderer<TileMobCrystal> {
    ...
    private static final RenderType LAYER = RenderType.getEntityCutoutNoCull(new ResourceLocation(Mystica.modid, "textures/block/mob_crystal.png"));
