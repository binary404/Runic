...
import binary404.mystica.common.entity.EntityCultOrb;
...
public class RenderCultOrb<T extends EntityCultOrb> extends EntityRenderer<T> {
    ...
    public void render(T entity, float p_225623_2_, float p_225623_3_, MatrixStack stack, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
        ...
        buffer.pos(matrix, (0.0F - f7), (0.0F - f8), 0.0F).color(1.0F, 1.0F, 1.0F, 1.0F).tex(f2, f5).normal(0.0F, 1.0F, 0.0F).endVertex();
        buffer.pos(matrix, (f6 - f7), (0.0F - f8), 0.0F).color(1.0F, 1.0F, 1.0F, 1.0F).tex(f3, f5).normal(0.0F, 1.0F, 0.0F).endVertex();
        buffer.pos(matrix, (f6 - f7), (1.0F - f8), 0.0F).color(1.0F, 1.0F, 1.0F, 1.0F).tex(f3, f4).normal(0.0F, 1.0F, 0.0F).endVertex();
        buffer.pos(matrix, (0.0F - f7), (1.0F - f8), 0.0F).color(1.0F, 1.0F, 1.0F, 1.0F).tex(f2, f4).normal(0.0F, 1.0F, 0.0F).endVertex();
    ...
    public ResourceLocation getEntityTexture(EntityCultOrb entity) {
        return new ResourceLocation("mystica", "textures/entity/orbs.png");
    }
}
