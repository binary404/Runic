...
public class EntityBeholder extends MonsterEntity implements IRangedAttackMob, IFlyingAnimal {
    ...
    public static AttributeModifierMap.MutableAttribute attributes() {
        return MonsterEntity.func_234295_eP_().createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.23F).createMutableAttribute(Attributes.FLYING_SPEED, 0.6F);
    }
    ...
    class WanderGoal extends Goal {
        ...
        public boolean shouldContinueExecuting() {
            return EntityBeholder.this.navigator.hasPath();
        }
