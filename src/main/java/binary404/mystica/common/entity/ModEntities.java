...
public class ModEntities {
    ...
    public static void registerEntities(RegistryEvent.Register<EntityType<?>> event) {
        ...
        event.getRegistry().register(EntityType.Builder.<EntityWeaveThread>create(EntityWeaveThread::new, EntityClassification.MISC).size(0.5F, 0.5F).build("").setRegistryName("mystica:thread"));
    }
