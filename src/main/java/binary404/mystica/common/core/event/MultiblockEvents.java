...
public class MultiblockEvents {
    ...
    static HashMap<RegistryKey<World>, Integer> serverTicks;
    private static HashMap<RegistryKey<World>, LinkedBlockingQueue<RunnableEntry>> serverRunList;
    public static HashMap<RegistryKey<World>, LinkedBlockingQueue<VirtualSwapper>> swapList;
    ...
    public static void worldTick(TickEvent.WorldTickEvent event) {
        ...
        final RegistryKey<World> dim = event.world.getDimensionKey();
    ...
    public static void addRunnableServer(final World world, final Runnable runnable, final int delay) {
        ...
        LinkedBlockingQueue<RunnableEntry> rlist = MultiblockEvents.serverRunList.get(world.getDimensionKey());
        if (rlist == null) {
            MultiblockEvents.serverRunList.put(world.getDimensionKey(), rlist = new LinkedBlockingQueue<RunnableEntry>());
        }
        rlist.add(new RunnableEntry(runnable, delay));
    }

    static {
        MultiblockEvents.serverTicks = new HashMap<RegistryKey<World>, Integer>();
        MultiblockEvents.serverRunList = new HashMap<RegistryKey<World>, LinkedBlockingQueue<RunnableEntry>>();
        MultiblockEvents.swapList = new HashMap<RegistryKey<World>, LinkedBlockingQueue<VirtualSwapper>>();
