...
public class BlockStorage extends Block {
    ...
    private static final VoxelShape MIDDLE = Block.makeCuboidShape(2, 7, 2, 12, 19, 12);
    private static final VoxelShape TOP = Block.makeCuboidShape(0, 23, 0, 16, 7, 16);
    private static final VoxelShape SHAPE = VoxelShapes.or(VoxelShapes.or(BASE, MIDDLE), TOP);

    public BlockStorage(Properties properties) {
        super(properties);
    }
